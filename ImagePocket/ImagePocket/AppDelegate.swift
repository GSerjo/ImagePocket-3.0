...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    fileprivate(set) var centerContainer: MMDrawerController!
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        centerContainer = MMDrawerController(center: centerSideNavigation, leftDrawerViewController: leftSideNavigation)
